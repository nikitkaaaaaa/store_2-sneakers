    ...
    <>
      <div className="header">
        <div style={{ display: "flex", alignItems: "center", padding: "50px" }}>
          <img
            src="https://cdn-icons-png.flaticon.com/128/1334/1334205.png"
            alt="avatar"
            className="avatar"
            onClick={goToMain}
          />
        ...
        >
          ...
          <img
            src="https://cdn.icon-icons.com/icons2/38/PNG/96/hearts_heart_love_favorite_5565.png"
            alt=""
            className="bookmarks"
          />
        </div>
